...
class _$_Question with DiagnosticableTreeMixin implements _Question {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Question(id: $id, content: $content, totalScore: $totalScore, examId: $examId, num: $num, supported: $supported)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('supported', supported));
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, content, totalScore, examId, num, supported);
...
abstract class _Question implements Question {
  const factory _Question(
      ...
      required final bool supported}) = _$_Question;
